...
namespace QLNT
{
    public partial class CashPayment : Form
    {
        ...
        public CashPayment(double cost)
        {
            ...
            complexCommand.setListControls(new List<Control>() { txtCost, txtChange, txtChangeCurrency });
        ...
        private void btnDoIt_Click(object sender, EventArgs e)
        {
            ...
            if(!rdVND.Checked)
            {
                ...
                complexCommand.setListControls(new List<Control>() { btnDoIt, rdEuro, rdUSD, rdVND, txtPayment });
                complexCommand.disable();
            }
        }
        ...
        public void createContextForExchange(String to)
        {
            ...
            textCommand.setListControls(new List<Control>() { txtChange, txtChangeCurrency });
            textCommand.disable();
        }
